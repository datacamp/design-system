...
### 4.1. When to use the Oxford comma: Body copy
...
### 4.2. When you should not use the Oxford comma: Short-form marketing and product copy
...
### 5.9. Titles, headlines, subtitles
...
## 6. DataCamp & Common Data Science Terminology
### 6.1. Account
...
### 6.5. Coding packages and libraries
...
### 6.9. DataFrames, data.frame, data frames
...
### 6.11. Fluency (as in data fluency)
...
### 6.18. Correct spelling of general technology terms
* e-book
* email
* cellphone
* Facebook
...
## 7. Course Naming Guidelines
### 7.1. General guidelines for all course names
* Descriptive
...
### 7.10. Technologies, coding languages and packages
