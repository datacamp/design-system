...
export default () => {
  ...
  return (    
    <Page>
      ...
      <table className="table">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <div className="dc-u-h-32 dc-u-w-32 dc-u-b" style={docsCustomBgLight}></div>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <div className="dc-u-h-32 dc-u-w-32 dc-u-bt" style={docsCustomBgLight}></div>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <div className="dc-u-h-32 dc-u-w-32 dc-u-br" style={docsCustomBgLight}></div>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <div className="dc-u-h-32 dc-u-w-32 dc-u-bb" style={docsCustomBgLight}></div>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <div className="dc-u-h-32 dc-u-w-32 dc-u-bl" style={docsCustomBgLight}></div>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table className="table">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <div className="dc-u-h-32 dc-u-w-32 dc-u-b-none" style={{...docsHasBorder, ...docsCustomBgLight}}></div>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <div className="dc-u-h-32 dc-u-w-32 dc-u-bt-none" style={{...docsHasBorder, ...docsCustomBgLight}}></div>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <div className="dc-u-h-32 dc-u-w-32 dc-u-br-none" style={{...docsHasBorder, ...docsCustomBgLight}}></div>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <div className="dc-u-h-32 dc-u-w-32 dc-u-bb-none" style={{...docsHasBorder, ...docsCustomBgLight}}></div>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <div className="dc-u-h-32 dc-u-w-32 dc-u-bl-none" style={{...docsHasBorder, ...docsCustomBgLight}}></div>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <header>
        <h2>Color</h2>
        <p>Border color utility classes are named using the format .dc-u-bc-[color].</p>
