  ...
  return (
    <svg viewBox="0 0 34 36" {...props}>
      <defs>
        <path
          id="icon_svg__a"
          d="M16.985 35.973c-.193 0-.384-.05-.556-.142L2.805 28.378a1.151 1.151 0 01-.59-.886L.008 6.746a1.146 1.146 0 01.766-1.207L16.433.065c.246-.085.512-.085.758 0l16.001 5.47c.513.18.831.69.767 1.227l-2.54 20.748a1.15 1.15 0 01-.578.862l-13.288 7.454a1.16 1.16 0 01-.567.147z"
        />
      </defs>
