...
function SvgCaseStudies(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg width={192} height={192} {...props}>
      <defs>
        ...
        <path
          ...
          d="M106.568 171.043L94.82 181.435 3.024 111.609a4.8 4.8 0 0 1-1.894-3.82V7.113a4.8 4.8 0 0 1 7.2-4.157l35.594 20.55a9.6 9.6 0 0 1 4.8 8.314v11.553a4.8 4.8 0 0 0 2.4 4.157l50.644 29.24a9.6 9.6 0 0 1 4.8 8.314v85.958z"
        />
        <path
          id="case-studies_svg__h"
          d="M7.608 119.634a9.6 9.6 0 0 1-4.8-8.314V29.896c0-.178.01-.355.029-.53L.47 28.55l5.135-3.018a4.794 4.794 0 0 1 4.402.207l93.62 54.052a9.6 9.6 0 0 1 4.8 8.314v86.713c.45 4.695 2.688 5.888 6.089 3.924 4.855-2.802 9.2-10.259 10.251-17.305V85.485a9.6 9.6 0 0 0-4.8-8.314l-50.644-29.24a4.8 4.8 0 0 1-2.4-4.157V32.221a9.6 9.6 0 0 0-4.8-8.314L26.53 3.357a4.8 4.8 0 0 0-4.711-.05l-.256-.148L26.267.442l.3.173a4.8 4.8 0 0 1 4.562.13l35.593 20.55a9.6 9.6 0 0 1 4.8 8.314v11.554a4.8 4.8 0 0 0 2.4 4.156l50.644 29.24a9.6 9.6 0 0 1 4.8 8.314v75.513l-.037.127c-.082 9.264-5.72 19.968-12.652 23.97-6.334 3.657-11.587.472-12.51-7.1l-96.56-55.749z"
        />
        <path
          id="case-studies_svg__k"
          d="M103.94 156.818H.407v-156H147.8v156h-43.86zm-2.172-4.435L5.208 96.634a9.6 9.6 0 0 1-4.8-8.314V6.896c0-.178.01-.355.029-.53C4.285 3.409 6.675 2.2 7.607 2.739l93.621 54.052a9.6 9.6 0 0 1 4.8 8.314v86.713c.26 2.709-.891 5-2.089 5-.878 0-1.781-1.232-2.171-4.435z"
        />
        <path
          id="case-studies_svg__m"
          d="M6.086.634C6.597.436 7.226.508 7.903.9l51.539 29.756c1.713.99 3.103 3.646 3.103 5.93v89.211c0 .983-.257 1.738-.688 2.2l.04.022-.154.09a1.57 1.57 0 0 1-.571.33l-3.183 1.837-10.527-6.078 2.572-1.486-42.13-24.324c-1.652-.954-3.004-3.459-3.099-5.684l-.005-.246V4.406L2.163 2.884 5.781.794c.06-.04.121-.076.185-.107l.107-.06z"
        />
        <path
        ...
        <path
          ...
          d="M110.807 155.643l-3.394-1.96L6.592 95.5a9.6 9.6 0 0 1-4.8-8.313V5.76a4.8 4.8 0 0 1 7.2-4.157l93.62 54.052a9.6 9.6 0 0 1 4.8 8.314v58.197l.012 23.951c.428 4.322 1.593 7.887 3.692 9.687l-.309-.162z"
        />
      </defs>
