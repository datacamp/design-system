...
function SvgPythonProgramming({
  ...
  return (
    ...
    >
      {title === undefined ? (
        <title id={titleId}>{'Python Programming'}</title>
      ) : title ? (
