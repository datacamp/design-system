...
function SvgReporting({
  ...
  return (
    ...
    >
      {title === undefined ? (
        <title id={titleId}>{'Reporting'}</title>
      ) : title ? (
      ...
      <defs>
        ...
        <path
          id="reporting_svg__d"
          d="M6.025.798c.82-.576 1.933-.579 3.158.128l75.763 43.742c2.518 1.455 4.562 5.36 4.562 8.718v108.342c0 1.762-.563 3.025-1.462 3.617v.001l-.03.019a2.29 2.29 0 01-.187.107l-5.614 3.241-15.706-9.068 4.427-2.556-61.753-35.654c-2.446-1.412-4.445-5.139-4.558-8.428l-.005-.289V6.576L.32 4.093z"
        />
        <path
          id="reporting_svg__g"
        ...
        <path
          id="reporting_svg__n"
          d="M7.025.798c.82-.576 1.933-.579 3.158.128l75.763 43.742c2.518 1.455 4.562 5.36 4.562 8.718v108.342c0 1.762-.563 3.025-1.462 3.617v.001l-.03.019a2.29 2.29 0 01-.187.107l-5.614 3.241-15.706-9.068 4.427-2.556-61.753-35.654c-2.446-1.412-4.445-5.139-4.558-8.428l-.005-.289V6.576l-4.3-2.483z"
        />
        <path
          id="reporting_svg__q"
          d="M86.598 54.722c0-3.358-2.044-7.264-4.562-8.718L6.272 2.262C3.754.808 1.71 2.354 1.71 5.712v108.341c0 3.358 2.044 7.264 4.562 8.718l75.764 43.742c2.518 1.453 4.562-.092 4.562-3.45V54.723z"
