  ...
  return (
    <svg width={192} height={192} {...props}>
      <defs>
        ...
        <path
          id="time-series_svg__D"
          d="M11.985 5.12l-.124-.071-.01.005c-.845-.39-1.908-.3-3.061.367-2.754 1.59-4.99 5.862-4.99 9.534 0 2.268.853 3.78 2.154 4.23l2.8 1.617 2.716-1.567-1.858-1.072c2.364-1.888 4.168-5.671 4.168-8.97a7.44 7.44 0 0 0-.157-1.57l1.348-.779L12.122 5.2a2.506 2.506 0 0 0-.137-.079z"
        />
        <path
        ...
        <path
          ...
          d="M12.985 5.12l-.124-.071-.01.005c-.845-.39-1.908-.3-3.061.367-2.754 1.59-4.99 5.862-4.99 9.534 0 2.268.853 3.78 2.154 4.23l2.8 1.617 2.716-1.567-1.858-1.072c2.364-1.888 4.168-5.671 4.168-8.97a7.44 7.44 0 0 0-.157-1.57l1.348-.779L13.122 5.2a2.506 2.506 0 0 0-.137-.079z"
        />
        <path
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g mask="url(#time-series_svg__c)">
          ...
          <g fill="#8AA7B8" fillRule="nonzero">
            <path d="M71.896 171.747V81.51a1.2 1.2 0 1 0-2.4 0v92.321a1.2 1.2 0 0 0 1.802 1.038l86.36-50.076a1.2 1.2 0 1 0-1.204-2.076l-84.558 49.031z" />
            <path d="M74.86 145.95l-4.766 2.842a1.2 1.2 0 1 0 1.203 2.076l4.766-2.84a1.2 1.2 0 0 0-1.204-2.077zm0-24l-4.766 2.842a1.2 1.2 0 1 0 1.203 2.076l4.766-2.84a1.2 1.2 0 0 0-1.204-2.077zm0-24l-4.766 2.842a1.2 1.2 0 1 0 1.203 2.076l4.766-2.84a1.2 1.2 0 0 0-1.204-2.077zm16.236 64.324v-5.922a1.2 1.2 0 1 0-2.4 0v5.922a1.2 1.2 0 1 0 2.4 0zm19.2-10.978v-5.922a1.2 1.2 0 1 0-2.4 0v5.922a1.2 1.2 0 1 0 2.4 0zm19.2-11.28v-5.921a1.2 1.2 0 1 0-2.4 0v5.921a1.2 1.2 0 1 0 2.4 0zm19.2-11.124v-5.922a1.2 1.2 0 1 0-2.4 0v5.922a1.2 1.2 0 1 0 2.4 0z" />
          </g>
          <g
            strokeLinecap="round"
