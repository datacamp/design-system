    ...
    <svg width={192} height={192} {...props}>
      <defs>
        ...
        <path
          ...
          d="M7.514 169.73l-5.418-3.127a3.6 3.6 0 0 1-1.8-3.118V62.432a9.6 9.6 0 0 1 4.802-8.315L97.927.553a3.6 3.6 0 0 1 3.6 0l5.595 3.23L7.692 61.19l-.178 108.54z"
        />
        <path id="data-manipulation_svg__g" d="M0 .151h111.243V112.8H0z" />
        <path
          id="data-manipulation_svg__j"
          d="M4.8 54.024L97.538.483a3.6 3.6 0 0 1 5.4 3.117v101.18a9.6 9.6 0 0 1-4.8 8.313L5.4 166.635a3.6 3.6 0 0 1-5.4-3.117V62.338a9.6 9.6 0 0 1 4.8-8.314z"
        />
        <path
        ...
        <path
          ...
          d="M7.514 169.73l-5.418-3.127a3.6 3.6 0 0 1-1.8-3.118V62.432a9.6 9.6 0 0 1 4.802-8.315L97.927.553a3.6 3.6 0 0 1 3.6 0l5.595 3.23-94.63 59.807.07 100.853-5.048 5.288z"
        />
        ...
        <path
          ...
          d="M4.183 5.676l4.834-2.79a2.4 2.4 0 0 1 3.6 2.078v88.193a4.8 4.8 0 0 1-2.4 4.156l-4.834 2.791a2.4 2.4 0 0 1-3.6-2.079V9.833a4.8 4.8 0 0 1 2.4-4.157z"
        />
        <path
        ...
        <path
          ...
          d="M21.908 3.549a3.6 3.6 0 0 1 .102.85v4.769a9.6 9.6 0 0 1-4.8 8.314L5.733 24.108c-.045.026-.09.05-.136.074L5.647 26l-3.02-1.655A3.6 3.6 0 0 1 .334 20.99v-4.769a9.6 9.6 0 0 1 4.8-8.314L16.61 1.281c.067-.038.134-.074.202-.108L17.51.77a3.6 3.6 0 0 1 3.6 0l2.806 1.62-2.008 1.159z"
        />
        <path
          id="data-manipulation_svg__L"
          d="M5.349 7.757L17.287.864a3.6 3.6 0 0 1 5.4 3.117v5.122a9.6 9.6 0 0 1-4.8 8.314L5.948 24.31a3.6 3.6 0 0 1-5.4-3.118V16.07a9.6 9.6 0 0 1 4.8-8.313z"
        />
        <path
          id="data-manipulation_svg__Q"
          d="M21.908 3.549a3.6 3.6 0 0 1 .102.85v4.769a9.6 9.6 0 0 1-4.8 8.314L5.733 24.108c-.045.026-.09.05-.136.074L5.647 26l-3.02-1.655A3.6 3.6 0 0 1 .334 20.99v-4.769a9.6 9.6 0 0 1 4.8-8.314L16.61 1.281c.067-.038.134-.074.202-.108L17.51.77a3.6 3.6 0 0 1 3.6 0l2.806 1.62-2.008 1.159z"
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g mask="url(#data-manipulation_svg__c)">
          ...
          <g transform="translate(108 51.6)">
            ...
            <path
              fill="#8AA7B8"
              d="M2.727 4.74l4.834-2.79a2.4 2.4 0 0 1 3.6 2.078V92.22a4.8 4.8 0 0 1-2.4 4.157l-4.834 2.79a2.4 2.4 0 0 1-3.6-2.078V8.897a4.8 4.8 0 0 1 2.4-4.157z"
          ...
          <g transform="translate(103 107.388)">
            <path
              fill="url(#data-manipulation_svg__E)"
              d="M5.257 13.659l11.477-6.626a3.6 3.6 0 0 1 5.4 3.118V24.52a9.6 9.6 0 0 1-4.8 8.313L5.857 39.46a3.6 3.6 0 0 1-5.4-3.117v-14.37a9.6 9.6 0 0 1 4.8-8.313z"
              filter="url(#data-manipulation_svg__F)"
              opacity={0.221}
            />
            <path
              fill="#000"
              d="M5.398 13.168l11.815-6.821a3.706 3.706 0 0 1 5.559 3.21v4.909a9.883 9.883 0 0 1-4.942 8.558L6.016 29.845a3.706 3.706 0 0 1-5.559-3.21v-4.908a9.883 9.883 0 0 1 4.941-8.559z"
