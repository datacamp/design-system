...
storiesOf('stylesheets', module).add('button', () => {
  return (
    <table>
      <tbody>
        <tr>
        ...
        <tr>
          <td>
            <button className="dc-btn dc-btn--red dc-btn--sm">red small</button>
          </td>
          <td>
            <button className="dc-btn dc-btn--red">red</button>
          </td>
          <td>
            <button className="dc-btn dc-btn--red dc-btn--lg">red large</button>
          </td>
        </tr>
        <tr>
          <td>
