...
- **color** – The color of the icon. This defaults to *currentColor*, and so will match the surrounding text. If a custom color is required, then this prop can accept any valid CSS color. We recommend using the [waffles-tokens](/components/tokens) to maintain a consistent visual experience.
