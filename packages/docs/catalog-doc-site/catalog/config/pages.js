...
const designUtilities = {
  ...
  pages: [
    ...
    },
    {
      ...
      title: 'Border',
      content: pageLoader(() => import('../pages/design-utilities/border.js')),
    },
    {
    ...
    },
    {
      ...
      title: 'Color',
      content: pageLoader(() => import('../pages/design-utilities/color.js')),
    },
    {
      path: '/design-utilities/cursor',
      title: 'Cursor',
      content: pageLoader(() => import('../pages/design-utilities/cursor.js')),
    },
    {
      path: '/design-utilities/display',
      title: 'Display',
      content: pageLoader(() => import('../pages/design-utilities/display.js')),
    },
    {
    ...
    },
    {
      ...
      title: 'Font',
      content: pageLoader(() => import('../pages/design-utilities/font.js')),
    },
    {
      path: '/design-utilities/height',
      title: 'Height',
      content: pageLoader(() => import('../pages/design-utilities/height.js')),
    },
    {
    ...
    },
    {
      ...
      title: 'List',
      content: pageLoader(() => import('../pages/design-utilities/list.js')),
    },
    {
      path: '/design-utilities/margin',
      title: 'Margin',
      content: pageLoader(() => import('../pages/design-utilities/margin.js')),
    },
    {
    ...
    },
    {
      ...
      title: 'Opacity',
      content: pageLoader(() => import('../pages/design-utilities/opacity.js')),
    },
    {
...
const components = {
  ...
  pages: [
    ...
    },
    {
      ...
      content: pageLoader(() =>
        import('../pages/components/count-indicator.md')
      ),
    },
    {
