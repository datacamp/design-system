    ...
    <main>
      ...
      <Page>
        <header>
          <h2>Additive</h2>
          <p>
            These classes add <code>min-width</code> properties to an element,
        ...
        <p>
          Min Width utilites can be used with pixels using the format{' '}
          <code>.dc-u-minw-[measure]</code>, where <code>[measure]</code> is one
          of the following:{' '}
          <code>
        ...
        <p>
          Min Width utilites can also be used with the following percentage
          units.
        </p>
