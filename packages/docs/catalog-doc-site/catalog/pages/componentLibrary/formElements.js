import { Input, Option, Select } from '@datacamp/waffles-form-elements';
...
export default () => {
    ...
    placeholder="an input with label and icon"
          ...
          <div className="dc-card dc-u-p-24 dc-u-mt-8">
            ...
            <Paragraph>
              ...
              waffles Option component as children. The Option component takes
  ...
  return (
    <Select name="test name" onChange={setValue} value={value}>
      ...
      <Option value="opt3" disabled>option3</Option>
  </Select>
  )
}`}
                    scope={{ ChevronDownIcon, Option, Select }}
                  />
                </tr>
              </tbody>
            </table>
