...
const components = [
  ...
  {
    docLink: '/component-library/resizable-elements',
    name: 'Resizable Elements',
    status: 'Available',
  },
  { docLink: '/component-library/assets', name: 'Assets', status: 'Available' },

  { name: 'Checkbox', status: 'Planned' },
  { name: 'Switch', status: 'Planned' },
  { name: 'Progress Bar', status: 'Planned' },
  { name: 'Avatars', status: 'Planned' },
